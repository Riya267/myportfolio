...
const Contact: React.FC<ContactProps> = ({isDarkMode}) => {
  ...
  return (
  <section id="contact" className={`${isDarkMode ? darkModeStyles : lightModeStyles} font-inter lg:h-screen flex flex-col items-center container`}>
     <p className='mb-6 font-xl border-b-2 border-primary-700'>
        CONTACT
      </p>
